/*  spaceinvaders.js
    ____     _____      ____          ______     _______    _______     __      ___   __                  __    ____      ______       _______    _______        ____
  /  __  \   |   __  \   /  __  \       /   __    \   |   _____|  |__     __|   |    \   |    |  \   \              /   /   /  __  \   |    __   \    |    _____|  |    __    \     /  __  \ 
/  /    \_\  |  |   \  \ |  |   |  |    /    /    \__\  |   |               |   |       |     \  |    |   \   \           /   /    |  |   |  |  |   |   \   \   |   |           |   |    \   \   /  /    \_\  
\  \____   |  |__/  / |  |__|  |  /    /             |   |___          |   |       |       \|    |    \   \         /   /     |  |__|  |  |   |    \   \  |   |___      |   |__/    /  \  \____ 
 \ ___   \  |   ___/  |   __   |  |   |               |   ___|          |   |       |             |     \   \      /   /       |   __   |  |   |     |   | |   ___|       |    _    /     \ ____  \ 
 __     \  \ |  |        |  |   |  |  \   \       __    |   |               |   |        |    |\      |      \   \   /   /         |  |   |  |  |   |     |   | |   |            |   | \   \      __     \  \  
 \  \ _ /  / |  |        |  |   |  |   \   \___/  /    |   |_____    __|   |__    |     | \    |       \   \/    /          |  |   |  |   |   |__/   /  |   |_____    |   |  \   \     \  \ _ /  / 
  \____/	   |_|        |_|   |_|    \______/      |_______|  |_______|   |___|  \__|        \____/            |_|   |_|   | _____ /    |_______|   |__|   \__\     \____/
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Space Invaders", game.width / 2, game.height/2 - 60); 
	var img=document.getElementById("alien");
	//var alien = new Alien();
   ctx.drawImage(img, game.width / 2-95, game.height / 2 - 50, this.alien.width, this.alien.height);
	ctx.font="22px Arial";
    ctx.fillText("= "+game.config.pointsPerInvader +" Points", game.width / 2-10, game.height / 2 - 30);
    ctx.font="22px Arial";
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    //  Draw ship.
	//document.getElementById('player'), this.ship.width, this.ship.height);
    //$('<div class="player"></div>').html(300, 350);
    ...
    //  Draw info.
	var html = "";
			for (i = 1; i<=game.lives && i <6; i++) {
				html += " <img src='images/player.png'>";
			}
			html +="<br>";
			for (i = 6; i<=game.lives; i++) {
				html += " <img src='images/player.png'>";
			}
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.textBaseline="middle"; 
    ctx.textAlign="center"; 
    ctx.fillText("Level " + this.level, game.width / 2, game.height/2-60);
    ctx.font="24px Arial";
    ctx.fillText("Ready in " + this.countdownMessage, game.width / 2, game.height/2 - 26);   
	var textYpos = game.gameBounds.bottom + ((game.height - game.gameBounds.bottom) / 2) + 14/2;
	ctx.font="22px Arial";
    ctx.fillStyle = '#ffffff';    
	var info = "Lives: " + game.lives;
